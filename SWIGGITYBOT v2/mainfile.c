...
#pragma config(Sensor, I2C_1,  FLI,            sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Sensor, I2C_2,  BLI,            sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Sensor, I2C_3,  BRI,            sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Sensor, I2C_4,  FRI,            sensorQuadEncoderOnI2CPort,    , AutoAssign)
#pragma config(Motor,  port2,           L1R1,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           FL,            tmotorVex393_MC29, PIDControl, encoderPort, I2C_1)
#pragma config(Motor,  port4,           L2R2,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           BL,            tmotorVex393_MC29, PIDControl, encoderPort, I2C_2)
#pragma config(Motor,  port6,           BR,            tmotorVex393_MC29, PIDControl, encoderPort, I2C_3)
#pragma config(Motor,  port8,           L3R3,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           FR,            tmotorVex393_MC29, PIDControl, encoderPort, I2C_4)
